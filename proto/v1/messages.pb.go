...
const file_proto_v1_messages_proto_rawDesc = "" +
	...
	"\x05trace\x18\x05 \x01(\v2\x17.wasimoff.v1.Task.TraceR\x05trace\x1aw\n" +
	"\x03QoS\x12\x1a\n" +
	"\bpriority\x18\x01 \x01(\bR\bpriority\x126\n" +
	"\bdeadline\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\bdeadline\x12\x1c\n" +
	"\timmediate\x18\x03 \x01(\bR\timmediate\x1as\n" +
	"\x05Trace\x12\x18\n" +
	"\acreated\x18\x01 \x01(\x03R\acreated\x12\x1a\n" +
	"\bduration\x18\x02 \x01(\x04R\bduration\x124\n" +
	"\x06events\x18\x03 \x03(\v2\x1c.wasimoff.v1.Task.TraceEventR\x06events\x1a\xac\a\n" +
	"\n" +
	"TraceEvent\x12\x1a\n" +
	"\bunixnano\x18\x01 \x01(\x03R\bunixnano\x12<\n" +
	"\x05event\x18\x02 \x01(\x0e2&.wasimoff.v1.Task.TraceEvent.EventTypeR\x05event\x12\x18\n" +
	"\adetails\x18\x03 \x01(\tR\adetails\"\xa9\x06\n" +
	"\tEventType\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\x0f\n" +
	"\vClientError\x10\n" +
	"\x12\x19\n" +
	"\x15ClientTransmitRequest\x10\v\x12\x1a\n" +
	"\x16ClientReceivedResponse\x10\f\x12\x0f\n" +
	"\vBrokerError\x10\x14\x12\x1f\n" +
	"\x1bBrokerReceivedClientRequest\x10\x15\x12\x13\n" +
	"\x0fBrokerQueueTask\x10\x16\x12\x16\n" +
	"\x12BrokerScheduleTask\x10\x17\x12\x1e\n" +
	"\x1aBrokerTransmitProviderTask\x10\x18\x12 \n" +
	"\x1cBrokerReceivedProviderResult\x10\x19\x12 \n" +
	"\x1cBrokerTransmitClientResponse\x10\x1a\x12\x11\n" +
	...
	"\x15ArtDecoSchedulerEnter\x10&\x12\x19\n" +
	"\x15ArtDecoSchedulerLeave\x10'\x12\x1d\n" +
	"\x19ArtDecoSchedulerScheduled\x10(\x12\x1f\n" +
	"\x1bArtDecoSchedulerResultEnter\x10)\x12\x1f\n" +
	"\x1bArtDecoSchedulerResultLeave\x10*\x12\x1d\n" +
	"\x19ArtDecoWasimoffSerialized\x10+\x12\x1f\n" +
	"\x1bArtDecoWasimoffDeserialized\x10,\x12#\n" +
	"\x1fArtDecoSchedulerProviderConnect\x10-\x12#\n" +
	"\x1fArtDecoSchedulerProviderOffload\x10.\x12\x1b\n" +
	"\x17ArtDecoSchedulerRequeue\x10/\x1a0\n" +
	"\x06Cancel\x12\x0e\n" +
	...
	"\x03err\x18\x02 \x01(\tR\x03err\"\xaf\x02\n" +
	"\x05Event\x1a*\n" +
	"\x0eGenericMessage\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x1aK\n" +
