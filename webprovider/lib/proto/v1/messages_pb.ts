...
export enum Task_TraceEvent_EventType {
  ...
  /**
   * scheduler has selected a provider to connect to
   *
   * @generated from enum value: ArtDecoSchedulerProviderConnect = 45;
   */
  ArtDecoSchedulerProviderConnect = 45,

  /**
   * scheduler has sent task to provider
   *
   * @generated from enum value: ArtDecoSchedulerProviderOffload = 46;
   */
  ArtDecoSchedulerProviderOffload = 46,

  /**
   * scheduler needs to requeue task because of connection/execution failure
   *
   * @generated from enum value: ArtDecoSchedulerRequeue = 47;
   */
  ArtDecoSchedulerRequeue = 47,
}

/**
 * @generated from enum wasimoff.v1.Task.TraceEvent.EventType
 */
export type Task_TraceEvent_EventTypeJson = "UNKNOWN" | "ClientError" | "ClientTransmitRequest" | "ClientReceivedResponse" | "BrokerError" | "BrokerReceivedClientRequest" | "BrokerQueueTask" | "BrokerScheduleTask" | "BrokerTransmitProviderTask" | "BrokerReceivedProviderResult" | "BrokerTransmitClientResponse" | "ProviderError" | "ProviderTaskReceived" | "ProviderGetWorker" | "ProviderPostToWorker" | "ProviderWorkerPrepare" | "ProviderWorkerExecute" | "ProviderWorkerDone" | "ProviderTransmitResult" | "ArtDecoSchedulerEnter" | "ArtDecoSchedulerLeave" | "ArtDecoSchedulerScheduled" | "ArtDecoSchedulerResultEnter" | "ArtDecoSchedulerResultLeave" | "ArtDecoWasimoffSerialized" | "ArtDecoWasimoffDeserialized" | "ArtDecoSchedulerProviderConnect" | "ArtDecoSchedulerProviderOffload" | "ArtDecoSchedulerRequeue";
 ...
 *
 * @generated from message wasimoff.v1.Ping
 */
export type Ping = Message<"wasimoff.v1.Ping"> & {
};
...
/**
 * Describes the message wasimoff.v1.Ping.
