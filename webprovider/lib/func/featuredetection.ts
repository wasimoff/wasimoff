...
export function CheckFeatures() {
  ...
  let results = [
    ...
    check(
      "WebSocket" in window && typeof window.WebSocket.constructor === "function",
    ...
    check(
      "WebAssembly" in window && typeof window.WebAssembly.constructor === "function",
    ...
    check(
      "Worker" in window && typeof window.Worker.constructor === "function",
